...
#' 
## ----impRFDef, fig.height=8, fig.cap="Importance of variables ranked in descending order for `spam` data."----
...
#' 
## ----impBagStump, fig.cap="Importance of the 20 most important variables for a Bagging of stumps, `spam` data."----
...
#' 
## ----impRFStump, fig.cap="Importance of the 20 most important variables for an RF of stumps with the default value of `mtry` (equal to 7), `spam` data."----
...
#' 
## ----impFried, fig.cap="Importance of variables, simulated data in regression."----
library(mlbench)
...
#' 
## ----impFriedPartialPlot, fig.cap="Marginal effects, simulated data in regression."----
...
#' 
## ----impOzoneRFDefImpPlot, fig.cap="Importance of variables, obtained with a default RF, `Ozone` data."----
...
#' 
## ----impVac18RFDefImpPlot, fig.height=6, fig.cap="Importance of the 30 most important variables sorted in descending order, `Vac18` data."----
varImpPlot(vacRFDefImp, type = 1, scale = FALSE, cex = 0.8)

#' 
## ----impVac18RFDefAllImpPlot, fig.cap="Importance of all variables sorted in descending order of importance, `Vac18` data."----
